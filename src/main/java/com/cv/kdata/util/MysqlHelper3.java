...
public class MysqlHelper3 {
	...
	static {
		...
		C3p0Plugin plugin = new C3p0Plugin("jdbc:mysql://106.14.115.221:3306/peseer_online?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&zeroDateTimeBehavior=convertToNull",
							"dataProduct", "dataProduct753", "com.mysql.jdbc.Driver");
		plugin.start();
